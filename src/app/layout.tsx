...
export default function RootLayout({
  ...
  return (
    ...
    <html lang="en">
      ...
      <body className="content-center items-center" style={{backgroundImage: "url('../images/foggy_birds.webp')"}}>
        <Link href={"/"}>
        ...
        <Authenticator formFields={formFields}>
          ...
          <div>
            ...
            <div className="-mt-10 gap-5 md:hidden bg-stone-100 w-100 pt-5 pl-4 text-stone-500 pb-3">
            ...
            <Card key="emergency"
              ...
              <CardFooter className="bg-stone-100 p-4 pt-0">
            ...
            <div className=" bg-stone-100 pb-4 border-t border-white/10 pt-8 ">
              <p className="text-xs leading-5 text-stone-400 text-center	">COPYRIGHT &copy; Iowa Bird Rehabilitation 2012-{new Date().getFullYear()}. ALL RIGHTS RESERVED.
              </p>
            </div>
          </div>
          )}
